...
<h1 align="center" style="font-size:36px; margin-bottom:20px;">Data Diri</h1>
<table>
<tr>
<td><table style="margin-left:500px; color: #000000; font-size:18px; margin-top:0px;">	
	...
	<tr style="height:30px;">
		...
		<td>:</td>
		<td><?php echo"$data2[goldar]";?></td>
	</tr>
	<tr style="height:30px;">
		<td style="width:200px;">Tinggi Badan</td>
		<td>:</td>
		<td><?php echo"$data2[t_badan]";?></td>
	</tr>
	<tr style="height:30px;">
		<td style="width:200px;">Berat Badan</td>
		<td>:</td>
		<td><?php echo"$data2[b_badan]";?></td>
	</tr>
	<tr style="height:30px;">
		<td style="width:200px;">Riwayat Sakit</td>
		<td>:</td>
		<td><?php echo"$data2[riwayat_sakit]";?></td>
	</tr>
		<tr style="height:30px;">
		<td style="width:200px;">Hobi</td>
		<td>:</td>
		<td><?php echo"$data2[hobi]";?></td>
	</tr>
		<tr style="height:30px;">
		<td style="width:200px;">Motivasi</td>
		<td>:</td>
		<td><?php echo"$data2[motivasi]";?></td>
	</tr>
...
<tr>
<td><p style="margin-left:-250px; margin-top:-330px;"><?php echo"<img src='gambar/$data[foto]' alt='#' style='width:300px; height:400px'/>";?></p>
</td></tr>
</table>
</p>
