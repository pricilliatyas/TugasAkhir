...
$tampil=mysqli_query($GLOBALS["___mysqli_ston"], "select * from pembina_ekskul");
 ...
 while($data=mysqli_fetch_array($tampil))
   ...
   <tr style='height:40px;'>
        ...
        <td>$data[foto]</td>
        ";?>
      <td  align="center"><a href="<?php echo "proses/aksi_pembina_ekskul.php?act=hapus&id=$data[no_urut_profil]";?>" onClick="return confirm('Apakah anda yakin akan menghapus data ini?')">Hapus</a> || 
   <a href="<?php echo"?hal=form_pembina_ekskul&act=ubah&id=$data[no_urut_profil]";?>">Ubah</a></td>  </tr>
    <?php
    $no++;}?>
</table>
              </div>
