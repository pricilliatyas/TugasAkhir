<h1 align="center" style="margin-top:30px;">Data Siswa</h1>
<?php 
    $id=isset($_GET['id'])?$_GET['id']:"";
    $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM pengguna WHERE no_pengguna='$id'"));
?>

<form action="proses/aksi_data_siswa.php?act=<?php if(empty($id)){echo"simpan";}else echo"ubah&id=$data[no_pengguna]";?>" method="post" enctype="multipart/form-data" onsubmit="return validasi();">
