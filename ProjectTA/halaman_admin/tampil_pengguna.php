...
<?php 
$tampil=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM pengguna WHERE level='member'");
 $no=1;
 while($data=mysqli_fetch_array($tampil))
   ...
   <tr style='height:40px; color:#000;'>
        ...
        <td>$data[level]</td>
        ";?>
      <td  align="center"><a href="<?php echo "proses/aksi_data_siswa.php?act=hapus&id=$data[no_pengguna]";?>" onClick="return confirm('Apakah anda yakin akan menghapus data ini?')"><img src="images/icon_delete.png" width="35px" height="35px"></a> || 
   <a href="<?php echo"?hal=form_data_siswa&act=ubah&id=$data[no_pengguna]";?>"><img src="images/icon_edit.png" width="30px" height="30px"></a></td>  </tr>
    <?php
    $no++;}?>
</table>
              </div>
